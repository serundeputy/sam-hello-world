...
```bash
sam-hello-world$ sam build --use-container
```
...
```bash
sam-hello-world$ pip install -r tests/requirements.txt --user
# unit test
sam-hello-world$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
sam-hello-world$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
